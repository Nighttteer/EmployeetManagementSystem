    ...
    <SafeAreaView style={styles.container}>
      ...
      >
                ...
                >
                  <View style={styles.mainStatHeader}>
                    ...
                    <View style={styles.mainStatTextContainer}>
                      <Text style={styles.mainStatTitle}>患者总数</Text>
                  ...
                  <Text style={styles.clickHint}>点击查看疾病分布</Text>
                </TouchableOpacity>
              </Card.Content>
            </Card>
          </View>
          ...
          <View style={styles.statsRow}>
            <Card style={styles.smallStatCard}>
              <Card.Content style={styles.smallStatContent}>
                ...
                <Text style={styles.smallStatTitle}>活跃告警</Text>
            ...
            <Card style={styles.smallStatCard}>
              <Card.Content style={styles.smallStatContent}>
                ...
                <Text style={styles.smallStatTitle}>今日咨询</Text>
                <View style={styles.smallStatTrend}>
            ...
            <Card style={styles.smallStatCard}>
              <Card.Content style={styles.smallStatContent}>
                ...
                <Text style={styles.smallStatTitle}>用药依从性</Text>
                <View style={styles.smallStatTrend}>
                  <Ionicons name="trending-up" size={12} color="#4CAF50" />
                  <Text style={styles.smallStatTrendText}>
        ...
        <Card style={styles.chartCard}>
          <Card.Content>
            <Text style={styles.chartTitle}>患者风险分布</Text>
            <PieChart
        ...
        <Card style={styles.chartCard}>
          <Card.Content>
            <Text style={styles.chartTitle}>告警类型分布</Text>
            <BarChart
        ...
        <Card style={styles.listCard}>
          <Card.Content>
            <View style={styles.listHeader}>
              <Text style={styles.listTitle}>最近患者活动</Text>
              <Button 
                mode="text" 
          ...
          <Card.Content>
            ...
            <View style={styles.actionButtons}>
              ...
              <Button
                mode="outlined"
                icon="medical"
                onPress={() => navigation.navigate('MedicationPlan')}
                style={styles.actionButton}
              >
                用药计划
              </Button>
